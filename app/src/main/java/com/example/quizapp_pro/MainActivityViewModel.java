    ...
    public MainActivityViewModel() {
        ...
        questionsArray = new Questions[]{ //Aquí se llenan las perguntas con sus debidas respuestas
                ...
                new Questions("¿Qué nombre recibe la feria más grande del Mundo de los Videojuegos?",
                        3, 31, answersArray[120], answersArray[121], answersArray[122], answersArray[123]),
                new Questions("¿En qué año se celebró para la primera E3?",
                        3, 32, answersArray[124], answersArray[125], answersArray[126], answersArray[127]),
                new Questions("¿En qué año fue lanzado el primer Call of Duty?",
                        3, 33, answersArray[128], answersArray[129], answersArray[130], answersArray[131]),
                new Questions("¿Cuál fue la primera videoconsola de la historia lanzada en 1972 en los EE.UU?",
                        3, 34, answersArray[132], answersArray[133], answersArray[134], answersArray[135]),
                new Questions("¿Cómo se llama la especia parasitaria que aparece en Halo?",
                        3, 35, answersArray[136], answersArray[137], answersArray[138], answersArray[139]),
                new Questions("¿Cuál fue la primera consola portátil a color y con pantalla retroiluminada?",
                        3, 36, answersArray[140], answersArray[141], answersArray[142], answersArray[143]),
                ...
                new Questions("¿En qué siglo tuvo lugar la Guerra de los Treinta Años?",
                        4, 41, answersArray[160], answersArray[161], answersArray[162], answersArray[163]),
                new Questions("¿Qué tratado puso fin a la guerra de los treinta años?",
                        4, 42, answersArray[164], answersArray[165], answersArray[166], answersArray[167]),
                new Questions("¿Quién descubrió la Penicilina?",
                        4, 43, answersArray[168], answersArray[169], answersArray[170], answersArray[171]),
                new Questions("¿En qué año se inició la revolución mexicana?",
                        4, 44, answersArray[172], answersArray[173], answersArray[174], answersArray[175]),
                new Questions("¿Qué continente fue asolado por la peste negra durante el siglo XIV?",
                        4, 45, answersArray[176], answersArray[177], answersArray[178], answersArray[179]),
                new Questions("¿En qué año se inauguró oficialmente el “Canal de Panamá”?",
                        4, 46, answersArray[180], answersArray[181], answersArray[182], answersArray[183]),
                new Questions("¿Cuánto duró la primera guerra mundial?",
                        4, 47, answersArray[184], answersArray[185], answersArray[186], answersArray[187]),
                new Questions("¿En qué año tuvo lugar “La gran depresión?",
                        4, 48, answersArray[188], answersArray[189], answersArray[190], answersArray[191]),
                new Questions("¿Quiénes inventaron el cinematógrafo?",
                        4, 49, answersArray[192], answersArray[193], answersArray[194], answersArray[195]),
                new Questions("¿En qué contiene tuvo lugar la “Guerra de los Seis Días”?",
                        4, 50, answersArray[196], answersArray[197], answersArray[198], answersArray[199]),
                ...
                new Questions("¿Con qué otro nombre se conoce a los dientes de leche?",
                        5, 51, answersArray[200], answersArray[201], answersArray[202], answersArray[203]),
                new Questions("¿Qué dramaturgo escribió la obra “La Celestina”?",
                        5, 52, answersArray[204], answersArray[205], answersArray[206], answersArray[207]),
                new Questions("¿Qué país atacó a Estados Unidos en el conocido “Ataque a Pearl Harbor”?",
                        5, 53, answersArray[208], answersArray[209], answersArray[210], answersArray[211]),
                new Questions("¿Cómo se representa química el Estaño?",
                        5, 54, answersArray[212], answersArray[213], answersArray[214], answersArray[215]),
                new Questions("¿Qué elementos forman el compuesto químico “Amoníaco”?",
                        5, 55, answersArray[216], answersArray[217], answersArray[218], answersArray[219]),
                new Questions("¿Qué arte marcial fue creada por Bruce Lee?",
                        5, 56, answersArray[220], answersArray[221], answersArray[222], answersArray[223]),
                new Questions("¿Cuántos años tardó en construirse el famoso Coliseo de Roma?",
                        5, 57, answersArray[224], answersArray[225], answersArray[226], answersArray[227]),
                new Questions("¿Qué figura geométrica estudia la trigonometría?",
                        5, 58, answersArray[228], answersArray[229], answersArray[230], answersArray[231]),
                new Questions("Qué aparato se utiliza para medir la presión atmosférica?",
                        5, 59, answersArray[232], answersArray[233], answersArray[234], answersArray[235]),
                new Questions("¿En qué ciudad se fundó la ONU?",
                        5, 60, answersArray[236], answersArray[237], answersArray[238], answersArray[239])
